 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kap /home/wzl/LFPy/project/conductance_measurement/realistic_neuron/hippocampal_pyramidal_neuron/mod/kaprox.mod\n");
...
static void _hoc_states(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for states_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 65 in file kaprox.mod:\n	SOLVE states \n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/hippocampal_pyramidal_neuron/mod/kaprox.mod";
