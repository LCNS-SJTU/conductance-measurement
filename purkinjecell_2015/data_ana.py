...
# estimated_mean_cond_dend= np.loadtxt("/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/purkinjecell_2015/estimated_mean_cond_passive_dendloc1599_fI6e3.txt")
...
# shapeplot(var_dend,  
#         figname = 'passive_local_us_fI6e3', cmap = cm.jet,
#         savefig = True, colorbarlabel='relative error',ticklabels=False,
#         tickmin=0, tickmax = 0.3, dt=0.15,  setv=True, vmin=0., vmax = 0.3)


# var_dend = np.abs(estimated_mean_cond_trad_dend - ground_truth*fE)/(ground_truth*fE)
# print(np.min(var_dend),np.max(var_dend))
# shapeplot(var_dend,  
#         figname = 'passive_local_trad_fI6e3', cmap = cm.jet,
#         savefig = True, colorbarlabel='relative error',ticklabels=False,
#         tickmin=0, tickmax = 0.3, dt=0.15,  setv=True, vmin=0., vmax = 0.3)


# estimated_mean_cond_dend= np.loadtxt("/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/purkinjecell_2015/estimated_mean_cond_active_dendloc1599_fI6e3.txt")
# estimated_mean_cond_us_dend = estimated_mean_cond_dend[:,0]
# estimated_mean_cond_trad_dend = estimated_mean_cond_dend[:,1]
...
# print(np.min(var_dend),np.max(var_dend))
# shapeplot(var_dend,  
#         figname = 'active_local_us_fI6e3', cmap = cm.jet,
#         savefig = True, colorbarlabel='relative error',ticklabels=False,
#         tickmin=0, tickmax = 0.3, dt=0.15,  setv=True, vmin=0., vmax = 0.3)
...
# print(np.min(var_dend),np.max(var_dend))
# shapeplot(var_dend,  
#         figname = 'active_local_trad_fI6e3', cmap = cm.jet,
#         savefig = True, colorbarlabel='relative error',ticklabels=False,
#         tickmin=0, tickmax = 0.3, dt=0.15,  setv=True, vmin=0., vmax = 0.3)
...
# estimated_lambdas_dend= np.loadtxt("/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/purkinjecell_2015/estimated_lambdas_passive_dendloc1599_fI6e3.txt")
...
estimated_lambdas_dend= np.loadtxt("/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/purkinjecell_2015/estimated_lambdas_active_dendloc1599_fI6e3.txt")
estimated_lambdas_dend_rise = -1./estimated_lambdas_dend[:,0]
estimated_lambdas_dend_decay = -1./estimated_lambdas_dend[:,1]
