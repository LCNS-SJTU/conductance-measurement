...
# morphologyFilename = "/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/L23PC/morphologies/cell1.asc"
# biophysicalModelFilename = "/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/L23PC/models/L23PCbiophys1.hoc"
# biophysicalModelTemplateFilename = "/home/wzl/LFPy/project/conductance_measurement/realistic_neuron/L23PC/models/L23PCtemplate.hoc"
...
#The code is compliant with the latest python indentation scheme - "11 October 2019"
...
def time_constant_fitting(run_dt, dtime, fE, E = True, loc=58 ,
                          block='',name= '', passive=False):
...
def time_constant_fitting_parallel(args,):
    ...
    estimated_lambda  = time_constant_fitting(
        0.1, 0.5, 6e-3, E = False, block='', name='', passive=False,
        loc=loc0)
...
np.savetxt("estimated_lambdas_active_dendloc1599_fI6e3.txt", estimated_lambdas)
